...
// general images
  ...
  static String shoppingCart2 = "$bagImagesPath/shopping_cart2.png";
  ...
  // Categories path
  static String cereal = "$categoriesImagesPath/cereal.png";
  static String cereal1 = "$categoriesImagesPath/cereal1.jpg";
  static String jams = "$categoriesImagesPath/jams.png";
  static String detergent = "$categoriesImagesPath/detergent.png";
  static String disinfectants = "$categoriesImagesPath/disinfectants1.png";
